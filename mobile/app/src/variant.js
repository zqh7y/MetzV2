 ...
 * transform, so the branches in App.js fold away and the screens the other app
 * uses are never reached — the light build does not carry the map, Explore,
 * the inbox or moderation.
 *
