...
const makeStyles = (t) => StyleSheet.create({
  ...
  arrowText: { fontSize: t.fs(22), color: t.text, fontFamily: FONTS.accent, lineHeight: 26 },
  monthLabel: { fontSize: t.fs(16), fontFamily: FONTS.heading, color: t.text },
  weekRow: { flexDirection: "row", marginTop: 14, marginBottom: 4 },
  weekday: {
    flex: 1, textAlign: "center", fontSize: t.fs(11), color: t.text3,
  ...
  dayText: { fontSize: t.fs(14), color: t.text, fontFamily: FONTS.bodyMedium },
  ...
  timeLabel: { fontSize: t.fs(11), color: t.text3, fontFamily: FONTS.bodySemi, textTransform: "uppercase" },
  timeValue: { fontSize: t.fs(20), color: t.text, fontFamily: FONTS.accent },
  columns: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, marginTop: 8 },
  column: { height: ROW * 3, width: 78 },
  colon: { fontSize: t.fs(20), color: t.text3, fontFamily: FONTS.accent },
  slot: { height: ROW, alignItems: "center", justifyContent: "center" },
  slotText: { fontSize: t.fs(17), color: t.text2, fontFamily: FONTS.bodyMedium },
  slotTextOn: { color: t.accentStrong, fontFamily: FONTS.accent, fontSize: t.fs(19) },
  warn: { marginTop: 10, fontSize: t.fs(12), color: t.status.bad, fontFamily: FONTS.bodyMedium, textAlign: "center" },
  actions: { flexDirection: "row", gap: 12, marginTop: 16 },
  cancel: {
    flex: 1, paddingVertical: 14, borderRadius: RADIUS.md, alignItems: "center",
    backgroundColor: t.surface2,
  },
  cancelText: { fontSize: t.fs(15), fontFamily: FONTS.bodySemi, color: t.text2 },
  confirm: {
    flex: 2, paddingVertical: 14, borderRadius: RADIUS.md, alignItems: "center",
    backgroundColor: t.accent,
  },
  confirmOff: { opacity: 0.45 },
  confirmText: { fontSize: t.fs(15), fontFamily: FONTS.accent, color: "#fff" },
});
