...
const makeStyles = (t) => StyleSheet.create({
  ...
  label: { flex: 1, fontSize: t.fs(11.5), fontFamily: FONTS.accent },
  deadline: { fontSize: t.fs(10.5), fontFamily: FONTS.bodySemi, color: t.text3, marginStart: 8 },
  track: { height: 6, borderRadius: 4, backgroundColor: t.surface3, overflow: "hidden" },
  fill: { height: "100%", borderRadius: 4 },
  full: { fontSize: t.fs(10.5), color: t.status.warn, fontFamily: FONTS.bodySemi, marginTop: 6 },
});
