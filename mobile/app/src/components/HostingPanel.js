...
const makeStyles = (t) => StyleSheet.create({
  ...
  emoji: { fontSize: t.fs(22) },
  rowTitle: { fontSize: t.fs(14.5), fontFamily: FONTS.bodySemi, color: t.text },
  when: { fontSize: t.fs(12), color: t.text3, fontFamily: FONTS.body, marginTop: 2 },
  pill: {
    paddingHorizontal: 10, paddingVertical: 5, borderRadius: RADIUS.pill,
    fontSize: t.fs(11.5), fontFamily: FONTS.bodySemi, overflow: "hidden",
  },
  ...
  emptyBody: { fontSize: t.fs(13.5), color: t.text2, fontFamily: FONTS.body, lineHeight: 19 },
  cta: {
    marginTop: 12, backgroundColor: t.accent, borderRadius: RADIUS.md,
    paddingVertical: 12, alignItems: "center",
  },
  ctaText: { color: "#fff", fontSize: t.fs(14.5), fontFamily: FONTS.accent },
});
