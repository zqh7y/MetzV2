...
const makeStyles = (t) => StyleSheet.create({
  ...
  pillText: { fontSize: 13, fontFamily: FONTS.bodySemi, color: t.text2 },
  pillTextOn: { color: t.accentStrong },
  point: { flexDirection: "row", alignItems: "center", gap: 12 },
  pointEmoji: { fontSize: 22 },
  pointText: { flex: 1, fontSize: 14.5, color: t.text2, fontFamily: FONTS.body, lineHeight: 20 },
  roleCard: {
  ...
  roleTitle: { fontSize: 15.5, fontFamily: FONTS.heading, color: t.text },
  roleTitleOn: { color: t.accentStrong },
  roleBody: { fontSize: 13, color: t.text2, fontFamily: FONTS.body, marginTop: 3, lineHeight: 18 },
  tick: {
  ...
  tickMark: { color: "#fff", fontSize: 13, fontFamily: FONTS.accent },
  primary: {
    backgroundColor: t.accent, borderRadius: RADIUS.md,
    paddingVertical: 15, alignItems: "center", marginTop: 8,
  },
  primaryOff: { opacity: 0.45 },
  primaryText: { color: "#fff", fontSize: 16, fontFamily: FONTS.accent },
  reassure: {
    marginTop: 12, textAlign: "center", fontSize: 12,
    color: t.text3, fontFamily: FONTS.body,
  },
  link: { color: t.accentStrong, fontSize: 14, fontFamily: FONTS.bodySemi, textAlign: "center" },
});
