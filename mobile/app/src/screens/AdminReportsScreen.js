...
const makeStyles = (t) => StyleSheet.create({
  ...
  tabText: { fontSize: t.fs(12.5), fontFamily: FONTS.bodySemi, color: t.text2 },
  tabTextActive: { color: t.accentOn },
  summary: { fontSize: t.fs(12), color: t.text3, fontFamily: FONTS.accent, marginTop: 10 },
  ...
  reasonText: { fontSize: t.fs(11), fontFamily: FONTS.accent, color: t.status.bad },
  reasonTextClosed: { color: t.text3 },
  kind: { fontSize: t.fs(11), color: t.text3, fontFamily: FONTS.bodySemi },
  when: { fontSize: t.fs(11), color: t.text3 },

  snapshot: { fontSize: t.fs(14), color: t.text, marginTop: 10, lineHeight: 19 },
  snapshotGone: { fontSize: t.fs(13), color: t.text3, marginTop: 10, fontStyle: "italic" },
  detail: { fontSize: t.fs(13), color: t.text2, marginTop: 8, lineHeight: 18, fontStyle: "italic" },
  reporter: { fontSize: t.fs(11.5), color: t.text3, marginTop: 10 },
  status: { fontSize: t.fs(12), fontFamily: FONTS.accent, color: t.text3, marginTop: 6 },
  ...
  ghostText: { fontSize: t.fs(12.5), fontFamily: FONTS.bodySemi, color: t.text2 },
  danger: {
  ...
  dangerText: { fontSize: t.fs(12.5), fontFamily: FONTS.accent, color: "#fff" },

  empty: { alignItems: "center", paddingTop: 60, paddingHorizontal: 30 },
  emptyTitle: { fontSize: t.fs(16), fontFamily: FONTS.heading, color: t.text },
  emptyBody: { fontSize: t.fs(13.5), color: t.text3, marginTop: 6, textAlign: "center" },
});
